...
CREATE TABLE IF NOT EXISTS account_balance (
    ...
    amount                 DECIMAL(24,8) NOT NULL DEFAULT 0.00000000 COMMENT 'CURRENT position balance in account currency',
    frozen_amount          DECIMAL(24,8) NOT NULL DEFAULT 0.00000000 COMMENT 'FROZEN position balance (compliance / legal hold)',
    locked_amount          DECIMAL(24,8) NOT NULL DEFAULT 0.00000000 COMMENT 'LOCKED position balance (pending Maker-Checker approval)',
...
CREATE TABLE IF NOT EXISTS journal_line (
    ...
    amount                       DECIMAL(24,8) NOT NULL       COMMENT 'Transaction amount in the currency unit (must be > 0)',
    balance_before               DECIMAL(24,8) NOT NULL       COMMENT 'Account balance before this journal line was applied',
    balance_after                DECIMAL(24,8) NOT NULL       COMMENT 'Account balance after this journal line was applied',
