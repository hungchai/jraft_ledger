...
public class AccountController {
    ...
    public ResponseEntity<?> close(@PathVariable String accountId, @RequestBody Map<String, String> body) {
        ...
        com.ibank.ledger.domain.command.AccountCloseCommand cmd =
                new com.ibank.ledger.domain.command.AccountCloseCommand(body.get("requestId"), accountId);
        CommandResult result;
        if (raftNodeManager != null) {
            result = raftNodeManager.submit(cmd);
        } else {
    ...
    public ResponseEntity<?> addBalanceType(@PathVariable String accountId, @RequestBody Map<String, String> body) {
        ...
        com.ibank.ledger.domain.command.AccountAddBalanceTypeCommand cmd =
                new com.ibank.ledger.domain.command.AccountAddBalanceTypeCommand(
