...
public class LedgerIntegrationTest {
    ...
    public void testIdempotentTransfer() throws Exception {
        ...
        ledgerService.createAccount("IdempotentUserA", Account.AccountType.AVAILABLE).get(5, TimeUnit.SECONDS);
        ledgerService.createAccount("IdempotentUserB", Account.AccountType.AVAILABLE).get(5, TimeUnit.SECONDS);
        ledgerService.createAccount("Bank", Account.AccountType.AVAILABLE).get(5, TimeUnit.SECONDS);
        
        // Fund IdempotentUserA from Bank
        ledgerService.transfer("Bank", Account.AccountType.AVAILABLE,
                              "IdempotentUserA", Account.AccountType.AVAILABLE,
                              new BigDecimal("1000.00"), "Initial funding").get(5, TimeUnit.SECONDS);
        ...
        String requestBody = """
            {
                "fromUserId": "IdempotentUserA",
                "fromType": "AVAILABLE",
                "toUserId": "IdempotentUserB", 
                "toType": "AVAILABLE",
                "amount": 100.00,
        ...
        BigDecimal balanceA = ledgerService.getBalance("IdempotentUserA", Account.AccountType.AVAILABLE);
        BigDecimal balanceB = ledgerService.getBalance("IdempotentUserB", Account.AccountType.AVAILABLE);
        
        assertEquals(new BigDecimal("900.00"), balanceA.setScale(2));
        assertEquals(new BigDecimal("100.00"), balanceB.setScale(2));
    }
